...
class Dataset:
    ...
    def percent_correct(self):
        """Compute percent correct."""  # how often the predicted label matches the true label
...
def best_correct(dataset: Dataset):
    ...
    for threshold in dataset.data.ravel():
        ...
        correct = (sum(labels_below == 0) + sum(labels_above == 1)) / dataset.data.size
...
def high_variance_projection(dataset: Dataset):
    """Compute the direction of the highest variance."""
...
# take the covariance matrix of the data and find the eigenvectors and eigenvalues of the covariance matrix
# eigenvalues will be decreasing. eigenvectors will be orthogonal
# dimension of highest variance in your data corresponds to the eigenvector with the highest eigenvalue
